...
class Generator(nn.Module):
    def __init__(self, input_code_dim=128, in_channel=128, pixel_norm=True, tanh=True, img_channels = 3):
        super().__init__()
        ...
        self.img_channels = img_channels # added by Vajira. No of channels in input images. and output images. 
        ...
        self.to_rgb_8 = EqualConv2d(in_channel, img_channels, 1)
        self.to_rgb_16 = EqualConv2d(in_channel, img_channels, 1)
        self.to_rgb_32 = EqualConv2d(in_channel, img_channels, 1)
        self.to_rgb_64 = EqualConv2d(in_channel//2, img_channels, 1)
        self.to_rgb_128 = EqualConv2d(in_channel//4, img_channels, 1)
        self.to_rgb_256 = EqualConv2d(in_channel//4, img_channels, 1)
...
class Discriminator(nn.Module):
    def __init__(self, feat_dim=128, img_channels = 3):
        super().__init__()
        ...
        self.from_rgb = nn.ModuleList([EqualConv2d(img_channels, feat_dim//4, 1),
                                       EqualConv2d(img_channels, feat_dim//4, 1),
                                       EqualConv2d(img_channels, feat_dim//2, 1),
                                       EqualConv2d(img_channels, feat_dim, 1),
                                       EqualConv2d(img_channels, feat_dim, 1),
                                       EqualConv2d(img_channels, feat_dim, 1),
                                       EqualConv2d(img_channels, feat_dim, 1)])
